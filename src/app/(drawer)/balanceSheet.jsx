...
const BalanceSheetScreen = () => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response =
        await balanceSheetsAPI.generateBalanceSheet({
  ...
  const downloadExcel = async () => {
    ...
    try {
      ...
      const summaryData = [
        ...
        [
          'Total Investments:',
          generatedData.summary.totalInvestments,
        ],
        [
          'Total Returns:',
          generatedData.summary.totalReturns,
        ],
        [
          'Total referrer payouts',
          generatedData.summary.totalCommissions,
        ],
        [
          'Net Worth:',
          generatedData.summary.netWorth,
        ],
      ];
      ...
      if (
        ...
        generatedData.transactions.forEach(
          tx => {
            ...
            csvContent +=
              `${date},${description},${type},${tx.amount || 0},${tx.balance || 0}\n`;
          }
        );
      } else {
        csvContent +=
            ...
            <div class="container">
              ...
              <div class="header">
                ...
                <p>
                  ...
                  ${generatedData.summary.period.start.slice(
                    0,
                    7
                  )} to
                  ${generatedData.summary.period.end.slice(
                    0,
                    7
                  )}
                </p>
      ...
      >
        ...
        >
          <Text style={styles.subtitle}>
            Select period to generate statement
          </Text>
